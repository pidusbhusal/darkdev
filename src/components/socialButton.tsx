...
export default function Social_button({ icon, name, link, alt }: socialbuttonprops) {
    return (
        ...
        ) : (<a href={link} target='_blank' className='flex justify-between group w-full sm:w-[19rem] px-6 py-4 hover:scale-105 transition ease-in-out  border-[1px] rounded border-slate-700 shadow-gray-800 bg-[#181A1E]  '>
